"""Auto-generated from Oracle-validated rule: discovered_not_constant_fold — not(c1, c2) → c3"""
from sare.engine import Transform, Graph
from typing import List, Tuple

class Discovered_DiscoveredNotConstantFold(Transform):
    """Discovered rule: not(c1, c2) → c3"""

    CONST_VAL = '0'
    OP_LABELS = ['not']

    def name(self) -> str:
        return 'discovered_not_constant_fold'
