"""Auto-generated from Oracle-validated rule: discovered_sin_2_identity — sin(x, 2) → x"""
from sare.engine import Transform, Graph
from typing import List, Tuple

class Discovered_DiscoveredSin2Identity(Transform):
    """Discovered rule: sin(x, 2) → x"""

    CONST_VAL = '2'
    OP_LABELS = ['sin']

    def name(self) -> str:
        return 'discovered_sin_2_identity'
