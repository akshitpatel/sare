"""Auto-generated from Oracle-validated rule: discovered_-_7_identity — -(x, 7) → x"""
from sare.engine import Transform, Graph
from typing import List, Tuple

class Discovered_Discovered7Identity(Transform):
    """Discovered rule: -(x, 7) → x"""

    CONST_VAL = '7'
    OP_LABELS = ['-']

    def name(self) -> str:
        return 'discovered_-_7_identity'
