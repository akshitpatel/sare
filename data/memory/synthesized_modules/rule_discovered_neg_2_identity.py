"""Auto-generated from Oracle-validated rule: discovered_neg_2_identity — neg(x, 2) → x"""
from sare.engine import Transform, Graph
from typing import List, Tuple

class Discovered_DiscoveredNeg2Identity(Transform):
    """Discovered rule: neg(x, 2) → x"""

    CONST_VAL = '2'
    OP_LABELS = ['neg']

    def name(self) -> str:
        return 'discovered_neg_2_identity'
