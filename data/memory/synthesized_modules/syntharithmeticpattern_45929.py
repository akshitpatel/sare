...
# Generated: 2026-04-16 18:57:35
# Name: syntharithmeticpattern_45929
...
class SynthArithmeticPattern_45929(Transform):
    def name(self) -> str:
        return "syntharithmeticpattern_45929"
    ...
    def apply(self, graph: Graph, context: Dict) -> Tuple[Graph, float]:
        ...
        if new_den_val == 1:
            new_node_id = g.add_node("constant", str(int(new_num_val) if new_num_val.is_integer() else new_num_val), {})
            for e in g.incoming(frac_id):
