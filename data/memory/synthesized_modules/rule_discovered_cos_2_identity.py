"""Auto-generated from Oracle-validated rule: discovered_cos_2_identity — cos(x, 2) → x"""
from sare.engine import Transform, Graph
from typing import List, Tuple

class Discovered_DiscoveredCos2Identity(Transform):
    """Discovered rule: cos(x, 2) → x"""

    CONST_VAL = '2'
    OP_LABELS = ['cos']

    def name(self) -> str:
        return 'discovered_cos_2_identity'
