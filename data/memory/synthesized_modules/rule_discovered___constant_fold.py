"""Auto-generated from Oracle-validated rule: discovered_+_constant_fold — +(c1, c2) → c3"""
from sare.engine import Transform, Graph
from typing import List, Tuple

class Discovered_DiscoveredConstantFold(Transform):
    ...
    def name(self) -> str:
        return 'discovered_+_constant_fold'
