"""Auto-generated from Oracle-validated rule: false_identity_for_disjunction — or(x, false) → x"""
from sare.engine import Transform, Graph
from typing import List, Tuple

class Discovered_FalseIdentityForDisjunction(Transform):
    """Discovered rule: or(x, false) → x"""

    CONST_VAL = 'false'
    OP_LABELS = ['or']

    def name(self) -> str:
        return 'false_identity_for_disjunction'
