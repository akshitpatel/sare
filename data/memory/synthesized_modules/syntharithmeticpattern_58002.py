...
# Generated: 2026-04-16 22:17:08
# Name: syntharithmeticpattern_58002
...
class SynthArithmeticPattern_58002(Transform):
    def name(self):
        return "syntharithmeticpattern_58002"
    ...
    def apply(self, graph: Graph, context: Dict):
        ...
        if "div_node" in context:
            ...
            g.add_edge(new_pow_id, var_id, "base")
            g.add_edge(new_pow_id, exp_id, "exponent")
