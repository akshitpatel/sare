"""Auto-generated from Oracle-validated rule: identity_law_for_disjunction — or(x, false) → x"""
from sare.engine import Transform, Graph
from typing import List, Tuple

class Discovered_IdentityLawForDisjunction(Transform):
    ...
    def name(self) -> str:
        return 'identity_law_for_disjunction'
