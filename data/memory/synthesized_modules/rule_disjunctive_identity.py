"""Auto-generated from Oracle-validated rule: disjunctive_identity — or(x, 0) → x"""
from sare.engine import Transform, Graph
from typing import List, Tuple

class Discovered_DisjunctiveIdentity(Transform):
    """Discovered rule: or(x, 0) → x"""

    def name(self) -> str:
        return 'disjunctive_identity'
