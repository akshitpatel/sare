"""Auto-generated from Oracle-validated rule: discovered_*_3_identity — *(x, 3) → x"""
from sare.engine import Transform, Graph
from typing import List, Tuple

class Discovered_Discovered3Identity(Transform):
    """Discovered rule: *(x, 3) → x"""

    CONST_VAL = '3'
    OP_LABELS = ['*']

    def name(self) -> str:
        return 'discovered_*_3_identity'
