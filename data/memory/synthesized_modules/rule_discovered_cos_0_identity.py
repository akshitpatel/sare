"""Auto-generated from Oracle-validated rule: discovered_cos_0_identity — cos(x, 0) → x"""
from sare.engine import Transform, Graph
from typing import List, Tuple

class Discovered_DiscoveredCos0Identity(Transform):
    """Discovered rule: cos(x, 0) → x"""

    CONST_VAL = '0'
    OP_LABELS = ['cos']

    def name(self) -> str:
        return 'discovered_cos_0_identity'
