"""Auto-generated from Oracle-validated rule: conjunction_of_constants — and(c1, c2) → c3"""
from sare.engine import Transform, Graph
from typing import List, Tuple

class Discovered_ConjunctionOfConstants(Transform):
    ...
    def name(self) -> str:
        return 'conjunction_of_constants'
