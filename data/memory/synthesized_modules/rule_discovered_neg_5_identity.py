"""Auto-generated from Oracle-validated rule: discovered_neg_5_identity — neg(x, 5) → x"""
from sare.engine import Transform, Graph
from typing import List, Tuple

class Discovered_DiscoveredNeg5Identity(Transform):
    """Discovered rule: neg(x, 5) → x"""

    CONST_VAL = '5'
    OP_LABELS = ['neg']

    def name(self) -> str:
        return 'discovered_neg_5_identity'
