"""Auto-generated from Oracle-validated rule: discovered_-_25_identity — -(x, 25) → x"""
from sare.engine import Transform, Graph
from typing import List, Tuple

class Discovered_Discovered25Identity(Transform):
    """Discovered rule: -(x, 25) → x"""

    CONST_VAL = '25'
    OP_LABELS = ['-']

    def name(self) -> str:
        return 'discovered_-_25_identity'
