"""Auto-generated from Oracle-validated rule: discovered_neg_3.0_identity — neg(x, 3.0) → x"""
from sare.engine import Transform, Graph
from typing import List, Tuple

class Discovered_DiscoveredNeg30Identity(Transform):
    """Discovered rule: neg(x, 3.0) → x"""

    CONST_VAL = '3.0'
    OP_LABELS = ['neg']

    def name(self) -> str:
        return 'discovered_neg_3.0_identity'
