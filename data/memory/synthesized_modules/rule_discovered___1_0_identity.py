"""Auto-generated from Oracle-validated rule: discovered_-_1.0_identity — -(x, 1.0) → x"""
from sare.engine import Transform, Graph
from typing import List, Tuple

class Discovered_Discovered10Identity(Transform):
    """Discovered rule: -(x, 1.0) → x"""

    def name(self) -> str:
        return 'discovered_-_1.0_identity'
