"""Auto-generated from Oracle-validated rule: discovered_-_12_identity — -(x, 12) → x"""
from sare.engine import Transform, Graph
from typing import List, Tuple

class Discovered_Discovered12Identity(Transform):
    """Discovered rule: -(x, 12) → x"""

    CONST_VAL = '12'
    OP_LABELS = ['-']

    def name(self) -> str:
        return 'discovered_-_12_identity'
