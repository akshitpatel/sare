"""Auto-generated from Oracle-validated rule: discovered_-_3.0_identity — -(x, 3.0) → x"""
from sare.engine import Transform, Graph
from typing import List, Tuple

class Discovered_Discovered30Identity(Transform):
    """Discovered rule: -(x, 3.0) → x"""

    def name(self) -> str:
        return 'discovered_-_3.0_identity'
