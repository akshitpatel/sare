...
# Generated: 2026-04-16 07:46:08
# Name: syntharithmeticpattern_05706
from sare.engine import Transform, Graph

class SynthArithmeticPattern_05706(Transform):
    def name(self):
        return "syntharithmeticpattern_05706"
            ...
            if n.type == "operator" and n.label == "/":
                ...
                if len(children) == 2:
                    ...
                    if left_node and right_node and left_node.label == right_node.label:
                        matches.append({"mul": n.id, "left": left_node.id, "right": right_node.id})
        return matches
    ...
    def apply(self, graph, context):
        ...
        if "div" in context:
            ...
            mul_id = context["mul"]
            var_node = g.get_node(context["left"])
            exp_id = g.add_node("operator", "^", {})
            const_id = g.add_node("constant", "2", {})
            g.add_edge(exp_id, var_node.id, "arg1")
