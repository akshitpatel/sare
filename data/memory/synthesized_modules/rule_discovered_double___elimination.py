"""Auto-generated from Oracle-validated rule: discovered_double_*_elimination — *(*(x)) → x"""
from sare.engine import Transform, Graph
from typing import List, Tuple

class Discovered_DiscoveredDoubleElimination(Transform):
    """Discovered rule: *(*(x)) → x"""

    def name(self) -> str:
        return 'discovered_double_*_elimination'
