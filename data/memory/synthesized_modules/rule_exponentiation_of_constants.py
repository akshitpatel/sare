"""Auto-generated from Oracle-validated rule: exponentiation_of_constants — ^(c1, c2) → c3"""
from sare.engine import Transform, Graph
from typing import List, Tuple

class Discovered_ExponentiationOfConstants(Transform):
    """Discovered rule: ^(c1, c2) → c3"""

    def name(self) -> str:
        return 'exponentiation_of_constants'
