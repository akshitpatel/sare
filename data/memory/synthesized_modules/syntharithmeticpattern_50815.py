...
# Generated: 2026-04-15 16:30:39
# Name: syntharithmeticpattern_50815
from sare.engine import Transform, Graph

class SynthArithmeticPattern_50815(Transform):
    def name(self):
        return "syntharithmeticpattern_50815"
    ...
    def apply(self, graph, context):
        ...
        if "div" in context:
            ...
            g.add_edge(exp_id, var_node.id, "arg")
            g.add_edge(exp_id, const_id, "arg")
            for e in list(g.edges):
                if e.target == mul_id:
                    g.remove_edge(e.id)
