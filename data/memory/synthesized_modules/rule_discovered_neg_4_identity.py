"""Auto-generated from Oracle-validated rule: discovered_neg_4_identity — neg(x, 4) → x"""
from sare.engine import Transform, Graph
from typing import List, Tuple

class Discovered_DiscoveredNeg4Identity(Transform):
    """Discovered rule: neg(x, 4) → x"""

    def name(self) -> str:
        return 'discovered_neg_4_identity'
