"""Auto-generated from Oracle-validated rule: discovered_-_50_identity — -(x, 50) → x"""
from sare.engine import Transform, Graph
from typing import List, Tuple

class Discovered_Discovered50Identity(Transform):
    """Discovered rule: -(x, 50) → x"""

    CONST_VAL = '50'
    OP_LABELS = ['-']

    def name(self) -> str:
        return 'discovered_-_50_identity'
