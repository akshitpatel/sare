"""Auto-generated from Oracle-validated rule: discovered_exp_0_identity — exp(x, 0) → x"""
from sare.engine import Transform, Graph
from typing import List, Tuple

class Discovered_DiscoveredExp0Identity(Transform):
    """Discovered rule: exp(x, 0) → x"""

    CONST_VAL = '0'
    OP_LABELS = ['exp']

    def name(self) -> str:
        return 'discovered_exp_0_identity'
