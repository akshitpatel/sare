"""Auto-generated from Oracle-validated rule: exponentiation_identity — exp(x, 1) → x"""
from sare.engine import Transform, Graph
from typing import List, Tuple

class Discovered_ExponentiationIdentity(Transform):
    ...
    def name(self) -> str:
        return 'exponentiation_identity'
