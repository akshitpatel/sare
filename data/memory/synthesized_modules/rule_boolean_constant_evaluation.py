"""Auto-generated from Oracle-validated rule: boolean_constant_evaluation — and(c1, c2) → c3"""
from sare.engine import Transform, Graph
from typing import List, Tuple

class Discovered_BooleanConstantEvaluation(Transform):
    ...
    def name(self) -> str:
        return 'boolean_constant_evaluation'
