"""Auto-generated from Oracle-validated rule: discovered_*_1_identity — *(x, 1) → x"""
from sare.engine import Transform, Graph
from typing import List, Tuple

class Discovered_Discovered1Identity(Transform):
    """Discovered rule: *(x, 1) → x"""

    CONST_VAL = '1'
    OP_LABELS = ['*']

    def name(self) -> str:
        return 'discovered_*_1_identity'
