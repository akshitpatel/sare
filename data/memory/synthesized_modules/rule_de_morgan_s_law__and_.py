"""Auto-generated from Oracle-validated rule: de_morgan's_law_(and) — Simplification via concept_de_morgan_and (removed 3 nodes)"""
from sare.engine import Transform, Graph
from typing import List, Tuple

class Discovered_DeMorganSLawAnd(Transform):
    """Discovered rule: Simplification via concept_de_morgan_and (removed 3 nodes)"""

    def name(self) -> str:
        return "de_morgan's_law_(and)"
