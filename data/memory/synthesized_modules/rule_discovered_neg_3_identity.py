"""Auto-generated from Oracle-validated rule: discovered_neg_3_identity — neg(x, 3) → x"""
from sare.engine import Transform, Graph
from typing import List, Tuple

class Discovered_DiscoveredNeg3Identity(Transform):
    """Discovered rule: neg(x, 3) → x"""

    CONST_VAL = '3'
    OP_LABELS = ['neg']

    def name(self) -> str:
        return 'discovered_neg_3_identity'
