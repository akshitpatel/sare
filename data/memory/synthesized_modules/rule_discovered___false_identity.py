"""Auto-generated from Oracle-validated rule: discovered_*_false_identity — *(x, false) → x"""
from sare.engine import Transform, Graph
from typing import List, Tuple

class Discovered_DiscoveredFalseIdentity(Transform):
    """Discovered rule: *(x, false) → x"""

    CONST_VAL = 'false'
    OP_LABELS = ['*']

    def name(self) -> str:
        return 'discovered_*_false_identity'
