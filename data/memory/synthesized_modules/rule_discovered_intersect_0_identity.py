"""Auto-generated from Oracle-validated rule: discovered_intersect_0_identity — intersect(x, 0) → x"""
from sare.engine import Transform, Graph
from typing import List, Tuple

class Discovered_DiscoveredIntersect0Identity(Transform):
    """Discovered rule: intersect(x, 0) → x"""

    CONST_VAL = '0'
    OP_LABELS = ['intersect']

    def name(self) -> str:
        return 'discovered_intersect_0_identity'
