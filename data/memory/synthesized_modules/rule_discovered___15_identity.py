"""Auto-generated from Oracle-validated rule: discovered_-_15_identity — -(x, 15) → x"""
from sare.engine import Transform, Graph
from typing import List, Tuple

class Discovered_Discovered15Identity(Transform):
    """Discovered rule: -(x, 15) → x"""

    CONST_VAL = '15'
    OP_LABELS = ['-']

    def name(self) -> str:
        return 'discovered_-_15_identity'
