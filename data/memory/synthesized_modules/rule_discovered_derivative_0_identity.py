"""Auto-generated from Oracle-validated rule: discovered_derivative_0_identity — derivative(x, 0) → x"""
from sare.engine import Transform, Graph
from typing import List, Tuple

class Discovered_DiscoveredDerivative0Identity(Transform):
    """Discovered rule: derivative(x, 0) → x"""

    CONST_VAL = '0'
    OP_LABELS = ['derivative']

    def name(self) -> str:
        return 'discovered_derivative_0_identity'
