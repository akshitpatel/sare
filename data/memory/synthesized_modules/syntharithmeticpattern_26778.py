...
# Generated: 2026-04-16 13:37:09
# Name: syntharithmeticpattern_26778
...
class SynthArithmeticPattern_26778(Transform):
    def name(self) -> str:
        return "syntharithmeticpattern_26778"
    ...
    def apply(self, graph: Graph, context: Dict) -> Tuple[Graph, float]:
        ...
        for e in incoming_edges:
            g.add_edge(e.source, new_num_id, e.relationship_type)
