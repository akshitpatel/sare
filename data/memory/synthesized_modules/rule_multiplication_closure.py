"""Auto-generated from Oracle-validated rule: multiplication_closure — *(c1, c2) → c3"""
from sare.engine import Transform, Graph
from typing import List, Tuple

class Discovered_MultiplicationClosure(Transform):
    """Discovered rule: *(c1, c2) → c3"""

    def name(self) -> str:
        return 'multiplication_closure'
