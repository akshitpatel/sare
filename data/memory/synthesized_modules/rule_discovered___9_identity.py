"""Auto-generated from Oracle-validated rule: discovered_^_9_identity — ^(x, 9) → x"""
from sare.engine import Transform, Graph
from typing import List, Tuple

class Discovered_Discovered9Identity(Transform):
    """Discovered rule: ^(x, 9) → x"""

    CONST_VAL = '9'
    OP_LABELS = ['^']

    def name(self) -> str:
        return 'discovered_^_9_identity'
