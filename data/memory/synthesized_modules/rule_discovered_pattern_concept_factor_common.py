"""Auto-generated from Oracle-validated rule: discovered_pattern_concept_factor_common — Simplification via concept_factor_common (removed 2 nodes)"""
from sare.engine import Transform, Graph
from typing import List, Tuple

class Discovered_DiscoveredPatternConceptFactorCommon(Transform):
    """Discovered rule: Simplification via concept_factor_common (removed 2 nodes)"""

    def name(self) -> str:
        return 'discovered_pattern_concept_factor_common'
