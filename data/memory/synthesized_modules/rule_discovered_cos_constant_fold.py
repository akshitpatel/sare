"""Auto-generated from Oracle-validated rule: discovered_cos_constant_fold — cos(c1, c2) → c3"""
from sare.engine import Transform, Graph
from typing import List, Tuple

class Discovered_DiscoveredCosConstantFold(Transform):
    """Discovered rule: cos(c1, c2) → c3"""

    def name(self) -> str:
        return 'discovered_cos_constant_fold'
