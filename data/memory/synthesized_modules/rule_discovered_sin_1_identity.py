"""Auto-generated from Oracle-validated rule: discovered_sin_1_identity — sin(x, 1) → x"""
from sare.engine import Transform, Graph
from typing import List, Tuple

class Discovered_DiscoveredSin1Identity(Transform):
    """Discovered rule: sin(x, 1) → x"""

    def name(self) -> str:
        return 'discovered_sin_1_identity'
