"""Auto-generated from Oracle-validated rule: discovered_^_2_identity — ^(x, 2) → x"""
from sare.engine import Transform, Graph
from typing import List, Tuple

class Discovered_Discovered2Identity(Transform):
    """Discovered rule: ^(x, 2) → x"""

    CONST_VAL = '2'
    OP_LABELS = ['^']

    def name(self) -> str:
        return 'discovered_^_2_identity'
