"""Auto-generated from Oracle-validated rule: discovered_log_0_identity — log(x, 0) → x"""
from sare.engine import Transform, Graph
from typing import List, Tuple

class Discovered_DiscoveredLog0Identity(Transform):
    """Discovered rule: log(x, 0) → x"""

    CONST_VAL = '0'
    OP_LABELS = ['log']

    def name(self) -> str:
        return 'discovered_log_0_identity'
