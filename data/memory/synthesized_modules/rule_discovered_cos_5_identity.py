"""Auto-generated from Oracle-validated rule: discovered_cos_5_identity — cos(x, 5) → x"""
from sare.engine import Transform, Graph
from typing import List, Tuple

class Discovered_DiscoveredCos5Identity(Transform):
    """Discovered rule: cos(x, 5) → x"""

    CONST_VAL = '5'
    OP_LABELS = ['cos']

    def name(self) -> str:
        return 'discovered_cos_5_identity'
