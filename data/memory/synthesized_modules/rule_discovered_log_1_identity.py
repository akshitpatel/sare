"""Auto-generated from Oracle-validated rule: discovered_log_1_identity — log(x, 1) → x"""
from sare.engine import Transform, Graph
from typing import List, Tuple

class Discovered_DiscoveredLog1Identity(Transform):
    """Discovered rule: log(x, 1) → x"""

    CONST_VAL = '1'
    OP_LABELS = ['log']

    def name(self) -> str:
        return 'discovered_log_1_identity'
