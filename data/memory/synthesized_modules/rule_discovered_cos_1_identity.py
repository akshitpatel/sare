"""Auto-generated from Oracle-validated rule: discovered_cos_1_identity — cos(x, 1) → x"""
from sare.engine import Transform, Graph
from typing import List, Tuple

class Discovered_DiscoveredCos1Identity(Transform):
    """Discovered rule: cos(x, 1) → x"""

    def name(self) -> str:
        return 'discovered_cos_1_identity'
