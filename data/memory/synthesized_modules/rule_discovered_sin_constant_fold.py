"""Auto-generated from Oracle-validated rule: discovered_sin_constant_fold — sin(c1, c2) → c3"""
from sare.engine import Transform, Graph
from typing import List, Tuple

class Discovered_DiscoveredSinConstantFold(Transform):
    """Discovered rule: sin(c1, c2) → c3"""

    def name(self) -> str:
        return 'discovered_sin_constant_fold'
