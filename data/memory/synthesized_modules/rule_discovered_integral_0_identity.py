"""Auto-generated from Oracle-validated rule: discovered_integral_0_identity — integral(x, 0) → x"""
from sare.engine import Transform, Graph
from typing import List, Tuple

class Discovered_DiscoveredIntegral0Identity(Transform):
    """Discovered rule: integral(x, 0) → x"""

    CONST_VAL = '0'
    OP_LABELS = ['integral']

    def name(self) -> str:
        return 'discovered_integral_0_identity'
