"""Auto-generated from Oracle-validated rule: discovered_and_true_identity — and(x, true) → x"""
from sare.engine import Transform, Graph
from typing import List, Tuple

class Discovered_DiscoveredAndTrueIdentity(Transform):
    """Discovered rule: and(x, true) → x"""

    CONST_VAL = 'true'
    OP_LABELS = ['and']

    def name(self) -> str:
        return 'discovered_and_true_identity'
