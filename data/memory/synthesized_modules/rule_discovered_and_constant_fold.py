"""Auto-generated from Oracle-validated rule: discovered_and_constant_fold — and(c1, c2) → c3"""
from sare.engine import Transform, Graph
from typing import List, Tuple

class Discovered_DiscoveredAndConstantFold(Transform):
    ...
    def name(self) -> str:
        return 'discovered_and_constant_fold'
