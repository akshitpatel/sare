...
# Generated: 2026-04-15 18:12:32
# Name: syntharithmeticpattern_56925
from sare.engine import Transform, Graph

class SynthArithmeticPattern_56925(Transform):
    def name(self):
        return "syntharithmeticpattern_56925"
    ...
    def apply(self, graph, context):
        ...
        if "div" in context:
            ...
            g.remove_node(g.get_node(context["var2"]).id)
            return g, -4.0
        return graph, 0.0