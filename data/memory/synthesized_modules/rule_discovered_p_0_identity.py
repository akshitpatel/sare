"""Auto-generated from Oracle-validated rule: discovered_p_0_identity — p(x, 0) → x"""
from sare.engine import Transform, Graph
from typing import List, Tuple

class Discovered_DiscoveredP0Identity(Transform):
    """Discovered rule: p(x, 0) → x"""

    CONST_VAL = '0'
    OP_LABELS = ['p']

    def name(self) -> str:
        return 'discovered_p_0_identity'
