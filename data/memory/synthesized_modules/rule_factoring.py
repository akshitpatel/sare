"""Auto-generated from Oracle-validated rule: factoring — Simplification via concept_factor_common (removed 4 nodes)"""
from sare.engine import Transform, Graph
from typing import List, Tuple

class Discovered_Factoring(Transform):
    """Discovered rule: Simplification via concept_factor_common (removed 4 nodes)"""
