"""Auto-generated from Oracle-validated rule: discovered_-_18_identity — -(x, 18) → x"""
from sare.engine import Transform, Graph
from typing import List, Tuple

class Discovered_Discovered18Identity(Transform):
    """Discovered rule: -(x, 18) → x"""

    CONST_VAL = '18'
    OP_LABELS = ['-']

    def name(self) -> str:
        return 'discovered_-_18_identity'
