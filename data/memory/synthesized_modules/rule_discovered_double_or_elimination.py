"""Auto-generated from Oracle-validated rule: discovered_double_or_elimination — or(or(x)) → x"""
from sare.engine import Transform, Graph
from typing import List, Tuple

class Discovered_DiscoveredDoubleOrElimination(Transform):
    """Discovered rule: or(or(x)) → x"""

    def name(self) -> str:
        return 'discovered_double_or_elimination'
