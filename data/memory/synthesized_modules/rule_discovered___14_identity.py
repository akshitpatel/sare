"""Auto-generated from Oracle-validated rule: discovered_-_14_identity — -(x, 14) → x"""
from sare.engine import Transform, Graph
from typing import List, Tuple

class Discovered_Discovered14Identity(Transform):
    """Discovered rule: -(x, 14) → x"""

    CONST_VAL = '14'
    OP_LABELS = ['-']

    def name(self) -> str:
        return 'discovered_-_14_identity'
