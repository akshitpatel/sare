"""Auto-generated from Oracle-validated rule: discovered_neg_true_identity — neg(x, true) → x"""
from sare.engine import Transform, Graph
from typing import List, Tuple

class Discovered_DiscoveredNegTrueIdentity(Transform):
    """Discovered rule: neg(x, true) → x"""

    CONST_VAL = 'true'
    OP_LABELS = ['neg']

    def name(self) -> str:
        return 'discovered_neg_true_identity'
