"""Auto-generated from Oracle-validated rule: discovered_and_0_identity — and(x, 0) → x"""
from sare.engine import Transform, Graph
from typing import List, Tuple

class Discovered_DiscoveredAnd0Identity(Transform):
    """Discovered rule: and(x, 0) → x"""

    def name(self) -> str:
        return 'discovered_and_0_identity'
