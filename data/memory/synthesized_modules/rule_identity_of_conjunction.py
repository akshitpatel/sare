"""Auto-generated from Oracle-validated rule: identity_of_conjunction — and(x, true) → x"""
from sare.engine import Transform, Graph
from typing import List, Tuple

class Discovered_IdentityOfConjunction(Transform):
    ...
    def name(self) -> str:
        return 'identity_of_conjunction'
