...
# Generated: 2026-04-16 12:05:50
# Name: syntharithmeticpattern_21260
...
class SynthArithmeticPattern_21260(Transform):
    def name(self):
        return "syntharithmeticpattern_21260"
    ...
    def apply(self, graph: Graph, context: Dict) -> Tuple[Graph, float]:
        ...
        if len(incoming_edges) == 1:
            ...
            g.add_edge(parent_edge.source, new_div_id, parent_edge.relationship_type)
            g.add_edge(new_div_id, new_num_id, "operand")
            g.add_edge(new_div_id, new_den_id, "operand")
            g.remove_node(div_id)
        else:
            g.add_edge(div_id, new_num_id, "operand")
            g.add_edge(div_id, new_den_id, "operand")
