"""Auto-generated from Oracle-validated rule: discovered_or_1_identity — or(x, 1) → x"""
from sare.engine import Transform, Graph
from typing import List, Tuple

class Discovered_DiscoveredOr1Identity(Transform):
    """Discovered rule: or(x, 1) → x"""

    def name(self) -> str:
        return 'discovered_or_1_identity'
