"""Auto-generated from Oracle-validated rule: discovered_union_0_identity — union(x, 0) → x"""
from sare.engine import Transform, Graph
from typing import List, Tuple

class Discovered_DiscoveredUnion0Identity(Transform):
    """Discovered rule: union(x, 0) → x"""

    CONST_VAL = '0'
    OP_LABELS = ['union']

    def name(self) -> str:
        return 'discovered_union_0_identity'
