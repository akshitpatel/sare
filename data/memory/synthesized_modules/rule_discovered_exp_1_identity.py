"""Auto-generated from Oracle-validated rule: discovered_exp_1_identity — exp(x, 1) → x"""
from sare.engine import Transform, Graph
from typing import List, Tuple

class Discovered_DiscoveredExp1Identity(Transform):
    """Discovered rule: exp(x, 1) → x"""

    CONST_VAL = '1'
    OP_LABELS = ['exp']

    def name(self) -> str:
        return 'discovered_exp_1_identity'
