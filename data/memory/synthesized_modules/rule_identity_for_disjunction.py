"""Auto-generated from Oracle-validated rule: identity_for_disjunction — *(x, false) → x"""
from sare.engine import Transform, Graph
from typing import List, Tuple

class Discovered_IdentityForDisjunction(Transform):
    ...
    def name(self) -> str:
        return 'identity_for_disjunction'
