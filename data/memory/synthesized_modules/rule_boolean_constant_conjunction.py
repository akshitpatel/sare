"""Auto-generated from Oracle-validated rule: boolean_constant_conjunction — and(c1, c2) → c3"""
from sare.engine import Transform, Graph
from typing import List, Tuple

class Discovered_BooleanConstantConjunction(Transform):
    """Discovered rule: and(c1, c2) → c3"""

    CONST_VAL = '0'
    OP_LABELS = ['and']

    def name(self) -> str:
        return 'boolean_constant_conjunction'
