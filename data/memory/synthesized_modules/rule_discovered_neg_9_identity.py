"""Auto-generated from Oracle-validated rule: discovered_neg_9_identity — neg(x, 9) → x"""
from sare.engine import Transform, Graph
from typing import List, Tuple

class Discovered_DiscoveredNeg9Identity(Transform):
    """Discovered rule: neg(x, 9) → x"""

    CONST_VAL = '9'
    OP_LABELS = ['neg']

    def name(self) -> str:
        return 'discovered_neg_9_identity'
