"""Auto-generated from Oracle-validated rule: discovered_neg_1_identity — neg(x, 1) → x"""
from sare.engine import Transform, Graph
from typing import List, Tuple

class Discovered_DiscoveredNeg1Identity(Transform):
    """Discovered rule: neg(x, 1) → x"""

    CONST_VAL = '1'
    OP_LABELS = ['neg']

    def name(self) -> str:
        return 'discovered_neg_1_identity'
