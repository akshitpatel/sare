"""Auto-generated from Oracle-validated rule: discovered_sin_0_identity — sin(x, 0) → x"""
from sare.engine import Transform, Graph
from typing import List, Tuple

class Discovered_DiscoveredSin0Identity(Transform):
    """Discovered rule: sin(x, 0) → x"""

    CONST_VAL = '0'
    OP_LABELS = ['sin']

    def name(self) -> str:
        return 'discovered_sin_0_identity'
