"""Auto-generated from Oracle-validated rule: discovered_neg_0_identity — neg(x, 0) → x"""
from sare.engine import Transform, Graph
from typing import List, Tuple

class Discovered_DiscoveredNeg0Identity(Transform):
    """Discovered rule: neg(x, 0) → x"""

    CONST_VAL = '0'
    OP_LABELS = ['neg']

    def name(self) -> str:
        return 'discovered_neg_0_identity'
