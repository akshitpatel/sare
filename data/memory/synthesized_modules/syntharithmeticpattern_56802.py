...
# Name: syntharithmeticpattern_56802
...
class SynthArithmeticPattern_56802(Transform):
    def name(self) -> str:
        return "syntharithmeticpattern_56802"
    ...
    def apply(self, graph: Graph, context: Dict) -> Tuple[Graph, float]:
        ...
        if "div_node" in context:
            ...
            value = context["value"]
            new_node_id = g.add_node("constant", str(int(value)), {})
