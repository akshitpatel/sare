"""Auto-generated from Oracle-validated rule: discovered_*_4_identity — *(x, 4) → x"""
from sare.engine import Transform, Graph
from typing import List, Tuple

class Discovered_Discovered4Identity(Transform):
    """Discovered rule: *(x, 4) → x"""

    CONST_VAL = '4'
    OP_LABELS = ['*']

    def name(self) -> str:
        return 'discovered_*_4_identity'
