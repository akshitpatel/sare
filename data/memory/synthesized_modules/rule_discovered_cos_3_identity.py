"""Auto-generated from Oracle-validated rule: discovered_cos_3_identity — cos(x, 3) → x"""
from sare.engine import Transform, Graph
from typing import List, Tuple

class Discovered_DiscoveredCos3Identity(Transform):
    """Discovered rule: cos(x, 3) → x"""

    CONST_VAL = '3'
    OP_LABELS = ['cos']

    def name(self) -> str:
        return 'discovered_cos_3_identity'
