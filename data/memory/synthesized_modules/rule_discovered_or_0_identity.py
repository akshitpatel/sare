"""Auto-generated from Oracle-validated rule: discovered_or_0_identity — or(x, 0) → x"""
from sare.engine import Transform, Graph
from typing import List, Tuple

class Discovered_DiscoveredOr0Identity(Transform):
    ...
    def name(self) -> str:
        return 'discovered_or_0_identity'
