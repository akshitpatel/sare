"""Auto-generated from Oracle-validated rule: discovered_not_1_identity — not(x, 1) → x"""
from sare.engine import Transform, Graph
from typing import List, Tuple

class Discovered_DiscoveredNot1Identity(Transform):
    """Discovered rule: not(x, 1) → x"""

    CONST_VAL = '1'
    OP_LABELS = ['not']

    def name(self) -> str:
        return 'discovered_not_1_identity'
