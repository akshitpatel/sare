"""Auto-generated from Oracle-validated rule: identity_of_disjunction — or(x, false) → x"""
from sare.engine import Transform, Graph
from typing import List, Tuple

class Discovered_IdentityOfDisjunction(Transform):
    ...
    def name(self) -> str:
        return 'identity_of_disjunction'
