"""Auto-generated from Oracle-validated rule: discovered_not_0_identity — not(x, 0) → x"""
from sare.engine import Transform, Graph
from typing import List, Tuple

class Discovered_DiscoveredNot0Identity(Transform):
    """Discovered rule: not(x, 0) → x"""

    CONST_VAL = '0'
    OP_LABELS = ['not']

    def name(self) -> str:
        return 'discovered_not_0_identity'
