"""Auto-generated from Oracle-validated rule: discovered_^_5_identity — ^(x, 5) → x"""
from sare.engine import Transform, Graph
from typing import List, Tuple

class Discovered_Discovered5Identity(Transform):
    """Discovered rule: ^(x, 5) → x"""

    CONST_VAL = '5'
    OP_LABELS = ['^']

    def name(self) -> str:
        return 'discovered_^_5_identity'
