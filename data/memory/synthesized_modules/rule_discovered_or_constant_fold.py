"""Auto-generated from Oracle-validated rule: discovered_or_constant_fold — or(c1, c2) → c3"""
from sare.engine import Transform, Graph
from typing import List, Tuple

class Discovered_DiscoveredOrConstantFold(Transform):
    """Discovered rule: or(c1, c2) → c3"""

    CONST_VAL = '0'
    OP_LABELS = ['or']

    def name(self) -> str:
        return 'discovered_or_constant_fold'
