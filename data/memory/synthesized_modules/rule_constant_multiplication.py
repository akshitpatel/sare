"""Auto-generated from Oracle-validated rule: constant_multiplication — *(c1, c2) → c3"""
from sare.engine import Transform, Graph
from typing import List, Tuple

class Discovered_ConstantMultiplication(Transform):
    ...
    def name(self) -> str:
        return 'constant_multiplication'
