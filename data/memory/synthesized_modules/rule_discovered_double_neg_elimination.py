"""Auto-generated from Oracle-validated rule: discovered_double_neg_elimination — neg(neg(x)) → x"""
from sare.engine import Transform, Graph
from typing import List, Tuple

class Discovered_DiscoveredDoubleNegElimination(Transform):
    """Discovered rule: neg(neg(x)) → x"""

    def name(self) -> str:
        return 'discovered_double_neg_elimination'
