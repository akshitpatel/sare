"""Auto-generated from Oracle-validated rule: multiplication_of_constants — *(c1, c2) → c3"""
from sare.engine import Transform, Graph
from typing import List, Tuple

class Discovered_MultiplicationOfConstants(Transform):
    ...
    def name(self) -> str:
        return 'multiplication_of_constants'
