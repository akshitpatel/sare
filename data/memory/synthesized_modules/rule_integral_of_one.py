"""Auto-generated from Oracle-validated rule: integral_of_one — integral(x, 1) → x"""
from sare.engine import Transform, Graph
from typing import List, Tuple

class Discovered_IntegralOfOne(Transform):
    """Discovered rule: integral(x, 1) → x"""

    CONST_VAL = '1'
    OP_LABELS = ['integral']

    def name(self) -> str:
        return 'integral_of_one'
