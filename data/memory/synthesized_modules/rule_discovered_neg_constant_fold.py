"""Auto-generated from Oracle-validated rule: discovered_neg_constant_fold — neg(c1, c2) → c3"""
from sare.engine import Transform, Graph
from typing import List, Tuple

class Discovered_DiscoveredNegConstantFold(Transform):
    """Discovered rule: neg(c1, c2) → c3"""

    CONST_VAL = '0'
    OP_LABELS = ['neg']

    def name(self) -> str:
        return 'discovered_neg_constant_fold'
