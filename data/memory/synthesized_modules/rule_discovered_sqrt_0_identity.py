"""Auto-generated from Oracle-validated rule: discovered_sqrt_0_identity — sqrt(x, 0) → x"""
from sare.engine import Transform, Graph
from typing import List, Tuple

class Discovered_DiscoveredSqrt0Identity(Transform):
    """Discovered rule: sqrt(x, 0) → x"""

    CONST_VAL = '0'
    OP_LABELS = ['sqrt']

    def name(self) -> str:
        return 'discovered_sqrt_0_identity'
