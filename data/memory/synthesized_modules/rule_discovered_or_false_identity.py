"""Auto-generated from Oracle-validated rule: discovered_or_false_identity — or(x, false) → x"""
from sare.engine import Transform, Graph
from typing import List, Tuple

class Discovered_DiscoveredOrFalseIdentity(Transform):
    ...
    def name(self) -> str:
        return 'discovered_or_false_identity'
