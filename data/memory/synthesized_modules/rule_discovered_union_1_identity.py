"""Auto-generated from Oracle-validated rule: discovered_union_1_identity — union(x, 1) → x"""
from sare.engine import Transform, Graph
from typing import List, Tuple

class Discovered_DiscoveredUnion1Identity(Transform):
    """Discovered rule: union(x, 1) → x"""

    CONST_VAL = '1'
    OP_LABELS = ['union']

    def name(self) -> str:
        return 'discovered_union_1_identity'
