"""Auto-generated from Oracle-validated rule: subtraction_of_constants — -(c1, c2) → c3"""
from sare.engine import Transform, Graph
from typing import List, Tuple

class Discovered_SubtractionOfConstants(Transform):
    """Discovered rule: -(c1, c2) → c3"""

    def name(self) -> str:
        return 'subtraction_of_constants'
