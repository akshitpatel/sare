"""Auto-generated from Oracle-validated rule: intersection_identity — intersect(x, 1) → x"""
from sare.engine import Transform, Graph
from typing import List, Tuple

class Discovered_IntersectionIdentity(Transform):
    """Discovered rule: intersect(x, 1) → x"""

    CONST_VAL = '1'
    OP_LABELS = ['intersect']

    def name(self) -> str:
        return 'intersection_identity'
