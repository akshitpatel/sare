"""Auto-generated from Oracle-validated rule: discovered_neg_false_identity — neg(x, false) → x"""
from sare.engine import Transform, Graph
from typing import List, Tuple

class Discovered_DiscoveredNegFalseIdentity(Transform):
    """Discovered rule: neg(x, false) → x"""

    CONST_VAL = 'false'
    OP_LABELS = ['neg']

    def name(self) -> str:
        return 'discovered_neg_false_identity'
