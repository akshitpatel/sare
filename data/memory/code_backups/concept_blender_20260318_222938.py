...
class InputSpace:
    ...
    def __post_init__(self):
        # Cache the structural features set once at construction time.
        # Since InputSpace.properties is treated as immutable after creation,
        # this avoids redundant set(self.properties.keys()) allocations on
        # every call to structural_features() during the O(n²) blend discovery loop.
        self._structural_features_cache: Set[str] = set(self.properties.keys())
